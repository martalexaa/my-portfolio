...
const MyflixCase = () => (
    <>
        <nav className="py-3 lg:mb-12 flex justify-end lg:mr-5 bg-black fixed top-0 w-full z-10">
        ...
        <main className="leading-8 text-gray-600">
            ...
            <div>
                ...
                <div className="pt-10 px-5 lg:px-56 ">
                ...
                <div className="flex justify-between gap-4 px-10 lg:px-56 pb-20 pt-10 text-gray-600">
                    <a href="https://martalexaa-movie-app.netlify.app/signup" target="blank"
                        className="text-gray-600 text-center cursor-pointer border-2 border-solid border-gray-500 px-1 text-xl">DEMO
                    </a>
                    <a href="https://github.com/martalexaa/myFlix-client"
                        target="blank"
                        className="text-gray-600 text-center cursor-pointer border-2 border-solid border-gray-500 px-1 text-xl ">CODE
                    </a>
                    <Link href="/"
                        className="text-gray-600 text-center cursor-pointer border-2 border-solid border-gray-500 px-1 text-xl">BACK
                    </Link>
                </div>
            </div>
